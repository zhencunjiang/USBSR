...
def parse_args():
    ...
    # general
    parser.add_argument(
        "--opt",default='/home/ps/zhencunjiang/US_sr/USBSR/options/us_fre.yml', help="experiment configure file name", required=True, type=str
    )
    parser.add_argument(
        "--root_path",
        help="experiment configure file name",
        default="/home/ps/zhencunjiang/US_sr/USBSR/",
        type=str,
    )
...
def validate(model, dataset, dist_loader, opt, measure, epoch, current_step):
    ...
    for (
        ...
        scores = measure(res=visuals["sr"].unsqueeze(dim=0), ref=cropped_gt_img, metrics=opt["metrics"])
...
if __name__ == "__main__":
    main()
# /home/ps/anaconda3/bin/python3.9 /home/ps/zhencunjiang/US_sr/USBSR/train.py --opt /home/ps/zhencunjiang/US_sr/USBSR/options/us_fre.yml
